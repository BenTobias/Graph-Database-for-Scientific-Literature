...
init = function(options) {
  ...
  if ((_base = config.options).overrideProtypeFunctions == null) {
    _base.overrideProtypeFunctions = false;
  }
  config.options.storeDocumentInGraphDatabase = false;
  if ((_base1 = config.options).cacheNodes == null) {
    _base1.cacheNodes = true;
  }
  if ((_base2 = config.options).loadMongoDBRecords == null) {
    _base2.loadMongoDBRecords = true;
  }
  if ((_base3 = config.options).extendSchemaWithMongoosePlugin == null) {
    _base3.extendSchemaWithMongoosePlugin = true;
  }
  if ((_base4 = config.options).relationships == null) {
    _base4.relationships = {};
  }
  if ((_base5 = config.options.relationships).storeTimestamp == null) {
    _base5.storeTimestamp = true;
  }
  config.options.relationships.storeIDsInRelationship = true;
  if ((_base6 = config.options.relationships).bidirectional == null) {
    _base6.bidirectional = false;
  }
  if ((_base7 = config.options.relationships).storeInDocument == null) {
    _base7.storeInDocument = false;
  }
  if ((_base8 = config.options).cacheAttachedNodes == null) {
