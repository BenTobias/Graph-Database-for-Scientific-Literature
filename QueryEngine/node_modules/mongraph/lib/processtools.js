...
populateResultWithDocuments = function(results, options, cb) {
  var final, graphdb, i, join, path, result, _fn, _i, _len, _ref, _ref1, _ref2;
  ...
  if ((_ref1 = options.where) != null) {
    if (_ref1.document == null) {
      _ref1.document = null;
    }
  }
  ...
  if (options.stripEmptyItems == null) {
  ...
  _fn = function(result, i) {
    var callback, collection, conditions, fromAndToJoin, intermediateCallback, isReferenceDocument, k, node, point, _fn1, _j, _k, _len1, _len2, _p, _ref10, _ref11, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _results;
    if (constructorNameOf(result) === 'Node' && ((_ref3 = result.data) != null ? _ref3._collection : void 0) && ((_ref4 = result.data) != null ? _ref4._id : void 0)) {
      callback = join.add();
      ...
      if (options.collection && options.collection !== result.data._collection) {
        ...
        conditions = _buildQueryFromIdAndCondition(result.data._id, !isReferenceDocument ? (_ref5 = options.where) != null ? _ref5.document : void 0 : void 0);
    ...
    } else if (constructorNameOf(result) === 'Relationship' && ((_ref7 = result.data) != null ? _ref7._from : void 0) && ((_ref8 = result.data) != null ? _ref8._to : void 0)) {
      callback = join.add();
      fromAndToJoin = Join.create();
      extendRelationship(result);
      _ref9 = ['from', 'to'];
      _fn1 = function(point, intermediateCallback) {
        var collectionName, _id, _ref10, _ref11, _ref12, _ref13;
        _ref10 = extractCollectionAndId(result.data["_" + point]), collectionName = _ref10.collectionName, _id = _ref10._id;
        ...
        if (options.collection && options.collection !== collectionName && !isReferenceDocument) {
          ...
          conditions = _buildQueryFromIdAndCondition(_id, !isReferenceDocument ? (_ref11 = options.where) != null ? _ref11.document : void 0 : void 0);
          if ((_ref12 = options.debug) != null) {
            if ((_ref13 = _ref12.where) != null) {
              _ref13.push(conditions);
            }
          }
      ...
      _ref10 = _p._nodes;
      _results = [];
      for (k = _k = 0, _len2 = _ref10.length; _k < _len2; k = ++_k) {
        node = _ref10[k];
        if ((_ref11 = node._data) != null ? _ref11.self : void 0) {
          callback = join.add();
          _results.push((function(k, callback) {
            return graphdb.getNode(node._data.self, function(err, foundNode) {
              var collectionName, _id, _ref12, _ref13, _ref14, _ref15;
              if (foundNode != null ? (_ref12 = foundNode.data) != null ? _ref12._id : void 0 : void 0) {
                ...
                if (options.collection && options.collection !== collectionName && !isReferenceDocument) {
                  ...
                  conditions = _buildQueryFromIdAndCondition(_id, (_ref13 = options.where) != null ? _ref13.document : void 0);
                  if ((_ref14 = options.debug) != null) {
                    if ((_ref15 = _ref14.where) != null) {
                      _ref15.push(conditions);
                    }
                  }
                  collection = getCollectionByCollectionName(collectionName, mongoose);
                  return collection.findOne(conditions, function(err, foundDocument) {
  ...
  return join.when(function() {
    var error, _ref3;
    _ref3 = sortJoins(arguments), error = _ref3.error, result = _ref3.result;
...
/*
//@ sourceMappingURL=processtools.map
*/
